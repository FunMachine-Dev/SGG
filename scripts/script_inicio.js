...
window.onload = function() {
    ...
    const userCorreo = localStorage.getItem('userCorreo'); // Recuperamos el correo del usuario
    if (userName) {
        document.getElementById('userName').innerText = userName;  // Asignamos solo el nombre al span
        document.getElementById('userId').innerText = userId;
        document.getElementById('userCorreo').textContent = userCorreo; // Asignamos el correo al span
    } else {
