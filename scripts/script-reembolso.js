    ...
    */
    ...
    function updateTotal() {
        ...
        inputs.forEach(function (input) {
            // Elimina el formato de separadores de miles antes de sumar
            var value = input.value; // Elimina los puntos
            total += parseInt(value, 10) || 0;
        });

        // Formatea el total y actualiza el campo correspondiente
